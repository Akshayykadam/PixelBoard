...
internal enum class RuntimeCallId(internal val encodedAbi: String) {
    ...
    AI_WRITING_TOOLS_RUNTIME_RESOLVE_DESCRIBE_DRAFT("Lcom/akshaykadam/pixelboard/extension/writingtools/GboardAiWritingToolsRuntime;->resolveDescribeDraft(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;"),
    AI_WRITING_TOOLS_RUNTIME_ADAPT_AI_RESPONSE("Lcom/akshaykadam/pixelboard/extension/writingtools/GboardAiWritingToolsRuntime;->adaptAiResponse(Ljava/lang/Object;)Ljava/lang/Object;"),
    AI_WRITING_TOOLS_RUNTIME_OBSERVE_EDITOR_INFO("Lcom/akshaykadam/pixelboard/extension/writingtools/GboardAiWritingToolsRuntime;->observeEditorInfo(Ljava/lang/Object;)V"),
